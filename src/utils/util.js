...
// SECURITY NOTE: helper that scrapes IPv4 addresses out of arbitrary text. Used
// together with the IP-collection calls in api/index.js (getIPByLink ->
// clientaddress). Flagged during audit as victim-tracking tooling unrelated to
// the stated DeFi functionality. See SECURITY_REPORT.md.
